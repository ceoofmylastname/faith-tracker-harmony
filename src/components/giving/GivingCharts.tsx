...
export default function GivingCharts() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative h-[300px] w-full transform transition-all duration-500 rounded-xl bg-gradient-to-br from-white/5 to-white/10 dark:from-gray-900/50 dark:to-gray-800/50 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_8px_30px_rgba(128,0,0,0.2)] dark:hover:shadow-[0_8px_30px_rgba(255,255,255,0.1)] backdrop-blur-sm border border-white/20">
